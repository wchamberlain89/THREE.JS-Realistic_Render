...
gltfLoader.load(
    ...
    (gltf) => {
        ...
        gui.add(gltf.scene.rotation, 'y').min(- Math.PI).max(Math.PI).step(0.001).name('Y Rotation')
...
gui.add(directionalLight, 'intensity').min(0).max(100).step(0.001).name('Light Intensity')
